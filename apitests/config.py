...
TEST_PREFFIX = {"waste air", "emission to air", "respiratory air", "soil air", "air"}
...
GROUPS_PREF_LABEL = [
    ...
    {"string": "AGRICULTURE, FORESTRY; ANIMAL HUSBANDRY; FISHERY", "language": "en"},
    {
        "string": "ANTHROPOSPHERE (built environment, human settlements, land setup)",
        "language": "en",
    },
    ...
    {"string": "HYDROSPHERE (freshwater, marine water, waters)", "language": "en"},
    ...
    {"string": "PHYSICAL ASPECTS, NOISE, VIBRATIONS, RADIATIONS", "language": "en"},
