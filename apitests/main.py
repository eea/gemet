...
class TestGetTopmostConcepts(unittest.TestCase):
    def test_terms(self):
        ...
        result = [
            top_concept["preferredLabel"]["string"] for top_concept in top_concepts
        ]
    ...
    def test_groups(self):
        top_groups = api_tester.request(
            "getTopmostConcepts",
            "thesaurus_uri",
            api_tester.get_full_path("group/"),
            "language",
            "en",
        )

        result = [top_group["preferredLabel"]["string"] for top_group in top_groups]
    ...
    def test_themes(self):
        top_themes = api_tester.request(
            "getTopmostConcepts",
            "thesaurus_uri",
            api_tester.get_full_path("theme/"),
            "language",
            "en",
        )

        result = [top_theme["preferredLabel"]["string"] for top_theme in top_themes]
    ...
    def test_inspire(self):
        top_inspire = api_tester.request(
            "getTopmostConcepts",
            "thesaurus_uri",
            api_tester.inspire_url,
            "language",
            "en",
        )
        result = [top_theme["preferredLabel"]["string"] for top_theme in top_inspire]
...
class TestGetRelatedConcepts(unittest.TestCase):
        ...
        if api_tester.GET_TEST:
            self.assertEqual(
                ...
                api_tester.request(
                    "getRelatedConcepts",
                    "concept_uri",
                    api_tester.get_full_path("concept/99999999"),
                    "relation_uri",
    ...
    def test_one_concept_english(self):
        ...
        result = [relative["preferredLabel"]["string"] for relative in relatives]
    ...
    def test_one_concept_spanish(self):
        ...
        self.assertEqual(result, [u"lluvia \xe1cida", u"acidificaci\xf3n de suelo"])
...
class TestGetConcept(unittest.TestCase):
    def test_no_concept(self):
        ...
        if api_tester.GET_TEST:
            self.assertEqual(
                "ERROR", api_tester.request("getConcept", *(concept_uri, language))
            )
        else:
            self.assertRaises(
                Fault,
    ...
    def test_one_concept_english(self):
        ...
        result = api_tester.request(
            "getConcept", "concept_uri", concept_uri, "language", language
        )
        ...
        self.assertEqual(result["thesaurus"], api_tester.get_full_path("concept/"))
        if not api_tester.LOCAL_TEST:
            self.assertEqual(result["uri"], api_tester.get_full_path("concept/7970"))
...
class TestHasConcept(unittest.TestCase):
    def test_concept_1(self):
        ...
        self.assertEqual(
            True, api_tester.request("hasConcept", "concept_uri", concept_uri)
        )
    ...
    def test_no_concept(self):
        ...
        self.assertEqual(
            False, api_tester.request("hasConcept", "concept_uri", concept_uri)
        )
    ...
    def test_bad_url(self):
        ...
        self.assertEqual(
            False, api_tester.request("hasConcept", "concept_uri", bad_uri)
        )
...
class TestHasRelation(unittest.TestCase):
    def test_broader(self):
        relation = (
            ...
            "object_uri",
            api_tester.get_full_path("concept/13292"),
        )
    ...
    def test_relation(self):
        relation = (
            ...
            "object_uri",
            api_tester.get_full_path("concept/661"),
        )
    ...
    def test_related(self):
        relation = (
            ...
            "http://www.w3.org/2004/02/skos/core#related",
            "object_uri",
            api_tester.get_full_path("concept/51"),
        )
    ...
    def test_theme(self):
        relation = (
            ...
            "object_uri",
            api_tester.get_full_path("theme/1"),
        )
    ...
    def test_groupMember(self):
        relation = (
            "concept_uri",
            api_tester.get_full_path("group/96"),
            "relation_uri",
            api_tester.get_full_path("2004/06/gemet-schema.rdf#groupMember"),
            "object_uri",
            api_tester.get_full_path("concept/21"),
        )
    ...
    def test_no_concept(self):
        relation = (
            "concept_uri",
            api_tester.get_full_path("concept/999999"),
            "relation_uri",
            "http://www.w3.org/2004/02/skos/core#broader",
            "object_uri",
            api_tester.get_full_path("concept/100"),
...
class TestGetAllTranslationsForConcept(unittest.TestCase):
    def test_getAllTranslationsForConcept(self):
        ...
        self.assertEqual(sorted(translations.items()), ALL_TTRANSLATIONS_FOR_CONCEPT)
...
class TestGetSupportedLanguages(unittest.TestCase):
    def test_getSupportedLanguages(self):
        ...
        if api_tester.LOCAL_TEST:
            ...
            self.assertEqual(
                sorted(result), sorted(TEST_SUPPORTED_LANGUAGES + TEST_EXTRA_LANGUAGES)
            )
...
class TestFetchThemes(unittest.TestCase):
    def test_fetchThemes_english(self):
        ...
        self.assertEqual([r["preferredLabel"] for r in result], THEMES_PREF_LABEL)
        if not api_tester.LOCAL_TEST:
    ...
    def test_fetchThemes_spanish(self):
        ...
        self.assertEqual(
            "turismo", sorted([r["preferredLabel"]["string"] for r in result])[-1]
        )
        if not api_tester.LOCAL_TEST:
            self.assertEqual(
                api_tester.get_full_path("theme/9"),
...
class TestFetchGroups(unittest.TestCase):
    def test_fetchGroups_english(self):
        ...
        self.assertEqual([r["preferredLabel"] for r in result], GROUPS_PREF_LABEL)
        if not api_tester.LOCAL_TEST:
...
class TestGetConceptsMatchingRegexByThesaurus(unittest.TestCase):
    ...
    def test_no_operator(self):
        ...
        names = self.get_match_names(match)
        self.assertEqual(names, ["resources", "social aspects, population", "soil"])
...
class TestGetAllConceptRelatives(unittest.TestCase):
    ...
    def test_random_supergroup(self):
        ...
        relatives = api_tester.request(
            "getAllConceptRelatives", "concept_uri", supergroup_uri
        )
        received_relations = []
        for relative in relatives:
            received_relations.append(
                "%s %s" % (relative["relation"], relative["target"])
            )
    ...
    def test_random_group(self):
        ...
        relatives = api_tester.request(
            "getAllConceptRelatives", "concept_uri", group_uri
        )
        received_relations = []
        for relative in relatives:
            received_relations.append(
        ...
        if not api_tester.LOCAL_TEST:
            self.assertEqual(
                received_relations[-1].split(" ")[0], self.relations["broader"]
            )
            self.assertEqual(
                received_relations[-1].split(" ")[1],
                api_tester.get_full_path("supergroup/2894"),
            )

            for relation in received_relations[:-2]:
                self.assertEqual(self.relations["groupMember"], relation.split(" ")[0])
            self.assertEqual(
                received_relations[0].split(" ")[1],
                api_tester.get_full_path("concept/100"),
            )
            self.assertEqual(
                received_relations[-2].split(" ")[1],
    ...
    def test_random_theme(self):
        ...
        relatives = api_tester.request(
            "getAllConceptRelatives", "concept_uri", theme_uri
        )
        received_relations = []
        for relative in relatives:
            received_relations.append(
        ...
        if not api_tester.LOCAL_TEST:
            for relation in received_relations:
                self.assertEqual(self.relations["themeMember"], relation.split(" ")[0])
            self.assertEqual(
                received_relations[0].split(" ")[1],
                api_tester.get_full_path("concept/100"),
            )
    ...
    def test_random_concept(self):
        ...
        relatives = api_tester.request(
            "getAllConceptRelatives", "concept_uri", concept_uri
        )
        received_relations = []
        for relative in relatives:
            received_relations.append(
...
class TestNamesConsistency(unittest.TestCase):
    def test_get_params_names(self):
        ...
        if api_tester.GET_TEST:
            self.assertEqual(
                "ERROR", api_tester.request("getConcept", "BAD_NAME", concept_uri)
            )
...
if __name__ == "__main__":
    ...
    get = options.get
    url = "http://127.0.0.1:8000/" if local else "http://www.eionet.europa.eu/gemet/"
