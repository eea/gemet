...
class TestAlphabeticView(GemetTest):
    ...
    def test_one_concept(self):
        ...
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(0)").text(), "administration"
        )
        self.assertEqual(
    ...
    def test_two_languages_one_preflabel(self):
        ...
        PropertyFactory(concept=concept)
        PropertyFactory(concept=concept, name="prefLabel", value="", language=spanish)
        ...
        self.assertEqual(resp.pyquery(".content ul:eq(0) li").size(), 1)
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(0)").text(),
            "administration [english]",
        )
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(0) a").attr("href"),
            reverse("concept", kwargs={"langcode": spanish.code, "code": concept.code}),
        )
    ...
    def test_more_concepts(self):
        ...
        self.assertEqual(resp.pyquery(".content ul:eq(0) li:eq(0)").text(), "Concept1")
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(0) a").attr("href"),
            reverse("concept", kwargs={"langcode": "en", "code": concept1.code}),
        )
        self.assertEqual(resp.pyquery(".content ul:eq(0) li:eq(1)").text(), "Concept2")
        self.assertEqual(
    ...
    def test_letter_selected_filter_one_language(self):
        ...
        url = "{url}?letter={letter}".format(
            url=reverse("alphabetic", kwargs={"langcode": "en"}), letter=1
        )
        resp = self.app.get(url)
        self.assertEqual(200, resp.status_int)
        self.assertEqual(resp.context["language"].code, "en")
        self.assertEqual(resp.pyquery(".content ul:eq(0) li").size(), 1)
        self.assertEqual(resp.pyquery(".content ul:eq(0) li").text(), "A_Concept")
        self.assertEqual(
    ...
    def test_wrong_letter_selected(self):
        ...
        url = "{url}?letter={letter}".format(
            url=reverse("alphabetic", kwargs={"langcode": "en"}), letter="lw"
        )
    ...
    def test_other_selected(self):
        ...
        url = "{url}?letter={letter}".format(
            url=reverse("alphabetic", kwargs={"langcode": "en"}), letter=99
        )
        resp = self.app.get(url)
        self.assertEqual(200, resp.status_int)
        self.assertEqual(resp.context["language"].code, "en")
        self.assertEqual(resp.pyquery(".content ul:eq(0) li").size(), 2)
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(0)").text(), '"A_Concept"'
        )
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(0) a").attr("href"),
            reverse("concept", kwargs={"langcode": "en", "code": concept1.code}),
        ...
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(1)").text(), '"B_Concept"'
        )
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(1) a").attr("href"),
            reverse("concept", kwargs={"langcode": "en", "code": concept2.code}),
    ...
    def test_letter_selected_filter_two_concepts_two_languages(self):
        ...
        self.assertEqual(resp.context["language"].code, "en")
        self.assertEqual(resp.pyquery(".content ul:eq(0) li").size(), 1)
        self.assertEqual(resp.pyquery(".content ul:eq(0) li").text(), "A_EN_Concept")
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li a").attr("href"),
    ...
    def test_404_error_letter_out_of_range(self):
        url = "{url}?letter={letter}".format(
            url=reverse("alphabetic", kwargs={"langcode": "en"}), letter=100
        )
        resp = self.app.get(url, expect_errors=True)
        self.assertEqual(404, resp.status_int)
        self.assertEqual(ERROR_404, resp.pyquery(".error404 h1").text())
...
class TestAlphabeticViewWithUser(GemetTest):
    ...
    def test_user_sees_modified_concept_names(self):
        ...
        PropertyFactory(concept=concept2, value="Concept2Old", status=DELETED_PENDING)
        ...
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(0) a").attr("href"),
            reverse("concept", kwargs={"langcode": "en", "code": self.concept1.code}),
        )
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(1)").text(), "Concept2New"
        )
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(1) a").attr("href"),
            reverse("concept", kwargs={"langcode": "en", "code": concept2.code}),
    ...
    def test_user_sees_new_concepts(self):
        ...
        self.assertEqual(resp.pyquery(".content ul:eq(0) li:eq(1)").text(), "Concept3")
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li:eq(1) a").attr("href"),
            reverse("concept", kwargs={"langcode": "en", "code": concept3.code}),
        )
    ...
    def test_user_sees_default_name(self):
        ...
        resp = self.app.get(url, user=self.user)
        self.assertEqual(
            resp.pyquery(".content ul:eq(0) li").text(), "Concept4 [english]"
        )
