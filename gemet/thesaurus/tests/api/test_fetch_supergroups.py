...
class TestFetchSuperGroups(GemetTest):
    def setUp(self):
        ...
        self._initialize(self.supergroup, "prefLabel1", "definition1", self.english)
    ...
    def test_default_language_parameter(self):
        ...
        self.assertEqual(resp.json[0]["preferredLabel"]["language"], DEFAULT_LANGCODE)

    def test_invalid_language(self):
        self.assertRaises(Fault, self.app.get, self.url + urlencode({"language": "es"}))
