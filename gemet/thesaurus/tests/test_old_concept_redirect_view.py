...
class TestOldConceptRedirectView(GemetTest):
    def test_concept(self):
        ...
        url = "{url}?ns={ns}&cp={cp}".format(
            url=reverse("old_concept_redirect"),
    ...
    def test_theme(self):
        ...
        url = "{url}?ns={ns}&cp={cp}".format(
            url=reverse("old_concept_redirect"), ns=theme.namespace.id, cp=theme.code
        )
        resp = self.app.get(url)
    ...
    def test_group(self):
        ...
        url = "{url}?ns={ns}&cp={cp}".format(
            url=reverse("old_concept_redirect"), ns=group.namespace.id, cp=group.code
        )
        resp = self.app.get(url)
    ...
    def test_language(self):
        concept = TermFactory()
        PropertyFactory(concept=concept)
        url = "{url}?langcode={lang}&ns={ns}&cp={cp}".format(
            url=reverse("old_concept_redirect"),
            ns=concept.namespace.id,
            cp=concept.code,
            lang="en",
    ...
    def test_404_no_namespace(self):
        ...
        url = "{url}?ns={ns}&cp={cp}".format(
            url=reverse("old_concept_redirect"), ns=5, cp=concept.code
        )
    ...
    def test_404_no_concept(self):
        ...
        url = "{url}?ns={ns}&cp={cp}".format(
            url=reverse("old_concept_redirect"), ns=concept.namespace.id, cp=5
        )
        resp = self.app.get(url, expect_errors=True)
    ...
    def test_404_no_ns_parameter(self):
        ...
        url = "{url}?cp={cp}".format(
            url=reverse("old_concept_redirect"), cp=concept.code
        )
        resp = self.app.get(url, expect_errors=True)
    ...
    def test_404_no_cp_parameter(self):
        ...
        url = "{url}?ns={ns}".format(
            url=reverse("old_concept_redirect"), ns=concept.namespace.id
        )
        resp = self.app.get(url, expect_errors=True)
    ...
    def test_404_no_concept_type(self):
        ...
        url = "{url}?langcode={lang}&ns={ns}&cp={cp}".format(
            url=reverse("old_concept_redirect"), ns=7, cp=concept.code, lang="en"
        )
        resp = self.app.get(url, expect_errors=True)
